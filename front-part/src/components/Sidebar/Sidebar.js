...
import nav_dashboard from './_nav_dashboard';
import nav_profil from './_nav_profil';
        ...
        const navDropdown = (item, key) => {
            return (
                <li key={key} className={activeRoute(item.url, props)}>
                    <a className="nav-link active nav-dropdown-toggle" href="#" onClick={handleClick.bind(this)}><i
