    ...
    def threader(container):
        ...
        while True:
            ...
            if date.second == 0:
                ...
                print("/////////////////////////////////////")
                print("NOTE : tables meres actualisees")
                
                tables = update.tables_1min()
                print("/////////////////////////////////////")
                print("NOTE : tables a 1min actualisees")

                period = json.dumps([{"period":"1min"}])
                data = json.dumps({"tick" : tables["tick"], "period" : period})

                try:                   
                    rep = requests.post("http://scanner:8080/pool_2", data = data)                   
                ...
                if date.minute in (0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55):
                    ...
                    print("/////////////////////////////////////")
                    print("NOTE : tables a 5min actualisees")

                    period = json.dumps([{"period":"5min"}])
                    data = json.dumps({"tick" : tables["tick"], "period" : period})
                    
                    try:
                        rep = requests.post("http://scanner:8080/pool_3", data = data)
                    ...
                    print("/////////////////////////////////////")
                    print("NOTE : tables a 15min actualisees")
                    ...
                    print("/////////////////////////////////////")
                    print("NOTE : tables a 30min actualisees")
                    ...
                    print("/////////////////////////////////////")
                    print("NOTE : tables a 1h actualisees")
                    ...
                    print("/////////////////////////////////////")
                    print("NOTE : tables a 2h actualisees")
                    ...
                    print("/////////////////////////////////////")
                    print("NOTE : tables a 4h actualisees")
                    ...
                    print("/////////////////////////////////////")
                    print("NOTE : tables a 1d actualisees")
                    ...
                    print("/////////////////////////////////////")
                    print("NOTE : tables a 1w actualisees")
                ...
                print("/////////////////////////////////////////////")
                print("""NOTE : duree des operations %s secondes"""%(round(float("""%s.%s"""%(date2.seconds, date2.microseconds)), 2)))
                print("/////////////////////////////////////////////")
                print("\n")
